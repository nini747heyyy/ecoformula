...
if os.path.exists(model_path):
    ...
    print(f"Warning: {model_path} not found. Using local function.")
...
def home():
    return jsonify({
        'message': 'Delivery Time Estimator API',
